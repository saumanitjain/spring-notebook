...
package com.oracle.communications.amplify.bizops.scheduler;
...
public class Application {
  ...
  public Application(@Value("${spring.application.name}") final String applicationName) {
    LOGGER.info("Starting up the demo {} application", applicationName);
  ...
  /**
   * Notifies the <code>Application</code> instance to perform a shutdown by closing the Spring
